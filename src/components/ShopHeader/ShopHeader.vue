<template>
  <div class="shop-header">
    ...
    <div class="shop-content" @click="changeShopShow">
    ...
    <div class="shop-header-discounts" v-if="shopinfo.supports" @click="changeShopSupportShow">
      <div class="discounts-left">
        <div class="activity" :class="supportColorClass[shopinfo.supports[0].type]">
          <span class="content-tag">
    ...
    <div class="activity-sheet" v-show="shopsupportShow">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">优惠活动</h2>
        <ul class="list">
          <li
            class="activity-item"
            :class="supportColorClass[support.type]"
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-close" @click="changeShopSupportShow"></span>
        </div>
      </div>
...
export default {
  data() {
    return {
      supportColorClass: ["activity-green", "activity-red", "activity-orange"],
      shopShow: false,
  ...
  methods: {
    ...
    changeShopSupportShow() {
      this.shopsupportShow = !this.shopsupportShow;
    }
  }
};
</script>
